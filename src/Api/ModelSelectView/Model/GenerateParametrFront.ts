...
import { Table } from './DynamicTableModel';
...
export class GenerateParametrs {
  constructor(public model: ModelSelect) {
    ...
    this.selectedtoserver = model.logicsSelectAutomationField;
  }


  public parametrs: SelectParam[];
  public selectedtoserver: LogicsSelectAutomation;
  ...
  private generateparametrs(modelselect: ModelSelect): SelectParam[] {
    ...
    for (const param of modelselect.infoViewAutomationField) {
  ...
  generatecommand(): LogicsSelectAutomation {
  ...
  generatecommandxml(columnDynamic: Table = null): LogicsSelectAutomation {
    var generate = new GenerateFullCommand();
...
class GenerateFullCommand {
  ...
  generateVisibleDynamic(logica: LogicsSelectAutomation, parametrs: SelectParam[], columnDynamic: Table = null): LogicsSelectAutomation {
    var command: LogicsSelectAutomation = new LogicsSelectAutomation()
    var str: string = '';
  ...
  generateVisible(logica: LogicsSelectAutomation, parametrs: SelectParam[]): LogicsSelectAutomation {
    var command: LogicsSelectAutomation = new LogicsSelectAutomation()
    var str: string = '';
    var countparam: number = parametrs.filter(sel => sel.isvisible === true).length
    var countend: number = 0;
  ...
  generateCommand(logica: LogicsSelectAutomation, select: SelectParam[]): LogicsSelectAutomation {
    var command: string;
